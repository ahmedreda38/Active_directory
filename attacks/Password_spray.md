...
- [Making a Target User List](#making-a-target-user-list)
- [Launching the Spray](#launching-the-spray)
- [Username-As-Password Check](#username-as-password-check)
- [Invoke-DomainPasswordSpray](#invoke-domainpasswordspray)
...
- Identify the password policy to prevent triggers with credentials
```bash
