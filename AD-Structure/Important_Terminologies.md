...
## Table of Contents
- [Directory Objects and Structure](#directory-objects-and-structure)
  - [Object](#object)
...
- [Identity and Naming](#identity-and-naming)
  - [Global Unique Identifier - GUID](#global-unique-identifier---guid)
  - [Security Identify - SID](#security-identify---sid)
  - [Distinguished Name - DN](#distinguished-name---dn)
  - [Relative Distinguished Name - RDN](#relative-distinguished-name---rdn)
  - [sAMAccountName](#samaccountname)
  - [userPrincipalName](#userprincipalname)
  - [Fully Qualified Domain Name - FQDN](#fully-qualified-domain-name---fqdn)
- [Domain Services and Roles](#domain-services-and-roles)
  - [Flexible Single Master Operation - FSMO Roles](#flexible-single-master-operation---fsmo-roles)
...
- [Access Control](#access-control)
  ...
  - [Access Control Entry - ACEs](#access-control-entry---aces)
...
- [Deleted Objects and Database](#deleted-objects-and-database)
  - [Tombstone](#tombstone)
