# NTLM Authentication and Hashes
...
- [NTLMv1 Net-NTLMv1](#ntlmv1-net-ntlmv1)
  - [How NTLMv1 Works High-Level](#how-ntlmv1-works-high-level)
  - [Key Security Weaknesses](#key-security-weaknesses)
  - [Captured Via](#captured-via)
- [NTLMv2 Net-NTLMv2](#ntlmv2-net-ntlmv2)
  - [How NTLMv2 Works Simplified](#how-ntlmv2-works-simplified)
  - [Security Characteristics](#security-characteristics)
- [Domain Cached Credentials MSCache2](#domain-cached-credentials-mscache2)
  - [How MSCache2 Works](#how-mscache2-works)
