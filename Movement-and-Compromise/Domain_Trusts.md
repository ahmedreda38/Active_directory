...
- [Enumerating Domain Trust](#enumerating-domain-trust)
- [Attacking Child To Parent Trusts](#attacking-child-to-parent-trusts)
- [ExtraSids Attack - Windows](#extrasids-attack---windows)
- [ExtraSids Attack - Linux](#extrasids-attack---linux)
- [Exploiting Cross-Forest Trust](#exploiting-cross-forest-trust)
...
## Attacking Child To Parent Trusts
